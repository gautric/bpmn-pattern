...
public class HandlerGlobalExceptionProcessTest extends JbpmJUnitBaseTestCase {
    ...
    public void testRetry() {
        ...
        addWorkItemHandler("WorkItemHandler", new WorkItemHandlerThrowingException(new ProcessWorkItemHandlerException("HandlerGlobalExceptionProcess","RETRY", new RuntimeException("Exception inside Test Case"))));

        
        final RuntimeManager runtimeManager = createRuntimeManager("net/a/g/jbpm/pattern/ExceptionToErrorProcess.bpmn", "net/a/g/jbpm/pattern/HandlerGlobalExceptionProcess.bpmn");
    ...
    public void testComplete() {
        ...
        addWorkItemHandler("WorkItemHandler", new WorkItemHandlerThrowingException(new ProcessWorkItemHandlerException("HandlerGlobalExceptionProcess","COMPLETE", new RuntimeException("Exception inside Test Case"))));
    ...
    public void testAbort() {
        ...
        addWorkItemHandler("WorkItemHandler", new WorkItemHandlerThrowingException(new ProcessWorkItemHandlerException("HandlerGlobalExceptionProcess","ABORT", new RuntimeException("Exception inside Test Case"))));
